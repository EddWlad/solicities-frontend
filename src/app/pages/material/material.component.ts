...
export class MaterialComponent implements OnInit, OnDestroy{
  columnDefinitions = [
    ...
    { def: 'description', label: 'Description', type: 'description', visible: true },
    { def: 'measurementUnit', label: 'Unidad', visible: true, type: 'text', cell: (row) => row.measurementUnit?.name },
    { def: 'cost', label: 'Price', type: 'price', visible: true },
  ...
  exportExcel() {
    ...
    const exportData = this.dataSource.filteredData.map((x) => ({
      ...
      measurementUnit: x.measurementUnit?.name,
